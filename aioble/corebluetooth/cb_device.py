...
class CoreBluetoothDevice(Device):
    ...
    def __init__(
        ...
        **kwargs
        ...
        from aioble.corebluetooth.service import (
            CoreBluetoothService as _service,
        )
    ...
    async def is_connected(self):
        ...
        return (
            self._cbperipheral.state()
            is CoreBluetooth.CBPeripheralStateConnected
        )
    ...
    async def service_with_identifier(
        self, identifier: str
    ...
    def peripheral_didDiscoverIncludedServices_error_(
    ...
    def peripheral_didOpenL2CAPChannel_error_(
        self, peripheral, channel, error
    ):
        pass
